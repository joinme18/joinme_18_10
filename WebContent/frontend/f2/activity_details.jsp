...
if("add".equals(request.getParameter("add_activity"))&&request.getMethod().equalsIgnoreCase("post")){
	...
	new SelectedActivityListDAO().addSelectedActivityList(/*(int)session.getAttribute("user_id")*/62, Integer.parseInt(request.getParameter("activity_id_add")));
	message ="activity added";
}else if(!"details".equals(request.getParameter("show_details"))||!request.getMethod().equalsIgnoreCase("post")){
	%>
							...
							<div class="col text-center">
								<div class="card">
									<div class="card-body">
										...
										<%System.out.print(adto.getActivity_id()); %>
										...
										<h4 class="text-sm-left">Name :<%=adto.getCost() %></h4>
										<h4 class="text-sm-left">Event date :<%=adto.getActivity_date() %></h4>
										<h4 class="text-sm-left">Activity Count :<%=adto.getCount()%></h4>
										<form action="">
